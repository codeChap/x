...
class Call {
    ...
    public function makeRequest(string $endpoint, array $data = [], string $method = 'POST', bool $isMediaUpload = false): array
    {
        $lastException = null;

        $url = $isMediaUpload ? 'https://upload.twitter.com/1.1/media/upload.json' : $this->baseUrl . $endpoint;
